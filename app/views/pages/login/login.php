...
<form class="form-horizontal" role="form" method="POST" action="<?= DynamicHtml::link_to('login/do') ?>">
    ...
    <div class="row" style="padding-top: 1rem">
        ...
        <div class="col-md-6">
			...
			<a class="btn btn-link" href="<?= DynamicHtml::link_to('login/forgot')?>">
				<?= Res::str('password_forgot_label') ?>
			</a>
			<a class="btn btn-link" href="<?= DynamicHtml::link_to('login/first_access')?>">
				<?= 'Primeiro acesso' ?>
			</a>
        </div>
    </div>
